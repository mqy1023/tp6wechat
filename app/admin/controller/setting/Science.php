    ...
    private function writeable()
    {
        ...
        return [
            [
                ...
                'status' => checkWriteable($paths['uploads']) ? 'normal' : 'danger',
            ...
            [
                ...
                'status' => checkWriteable($paths['temp']) ? 'normal' : 'danger',
...
//                'status' => checkWriteable($paths['wxpay_log']) ? 'normal' : 'danger',
//                'remark' => '目录不可写，系统将无法正常写入文件'
//            ],
            [
                'name' => '微信支付证书目录',
                ...
                'status' => checkWriteable($paths['wxpay_cert']) ? 'normal' : 'danger',
                'remark' => '目录不可写，系统将无法正常写入文件'
            ],
        ];
    }
